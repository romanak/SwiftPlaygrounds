...
class SleepCalculator {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        let file = bundle.url(forResource: "SleepCalculator", withExtension:"mlmodel")!
    ...
    */
    ...
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> SleepCalculator {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> SleepCalculator {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return SleepCalculator(model: model)
    }
